...
public class DatagramPacketEncoder extends MessageToMessageEncoder<DatagramPacketContext> {
    ...
    public DatagramPacketEncoder(Function<Class<? extends Packet>, Byte> packetIdSupplier) {
        this(packetIdSupplier, SAFE_MAX_PACKET_SIZE);
    }

    public DatagramPacketEncoder(Function<Class<? extends Packet>, Byte> packetIdSupplier,
                                 int packetSize) {

        this.encoder = new StreamPacketEncoder(packetIdSupplier);
